  ...
  <form action="{{ route('series.store') }}" method="POST">
    ...
    <div class="d-flex w-100 gap-2">
      <div class="mb-3 w-100">
          ...
          <input type="number" id="seasonQty" name="seasonQty" value="{{old('seasonQty')}}" class="form-control bg-transparent text-white">
      </div>
      <div class="mb-3 w-100">
          <label for="episodesPerSeason" class="text-white mb-2">№ de Episodios</label>
          <input type="number" id="episodesPerSeason" name="episodesPerSeason" value="{{old('episodesPerSeason')}}" class="form-control bg-transparent text-white">
      </div>
    </div>
